(() => {
  ...
  async function save() {
    const opts = {
      ...
      autoCaptureInterval: parseInt(document.getElementById("auto-capture-interval").value) || 5,
      ...
      synthing_apiUrl: document.getElementById("syncthing-api-url").value.trim() || DEFAULTS.synthing_apiUrl,
      syncthing_folder: document.getElementById("syncthing-folder").value.trim() || DEFAULTS.syncthing_folder,
